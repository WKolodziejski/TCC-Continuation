...
#ifndef DSP_MATHUTILS_H_
#define DSP_MATHUTILS_H_
...
static int least_squares(int n, double *A, int rows, int stride, double *b,
...
static double apply_sign(double a, double b) {
